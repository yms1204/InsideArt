...
import "../../pages/ArtworkPageForTeaser.css";
import agent from "../../images/agent.png";

function ChatWithFullTeaser({ artwork, initiateConversation }) {
  ...
  const handleSend = async () => {
    if (prompt.trim()) {
      ...
      saveChatLog({ pid, tid, type: "ChatWithFull", message: newMessage });
    }
  };
      ...
      <div className="messages-container">
        <div className="messages">
          ...
          <div className="message response">
            What stands out to you the most in this artwork? Is it the colors,
            the shapes, or perhaps the overall composition?
          </div>
          <div className="message query">
            The line shapes. It comes to me this artwork like illustration style
            artwork, driving neatness, clear, and sensitive feelings
          </div>
          {/* <img src={agent} alt="agent"></img> */}
          <div className="message response">
            The lines in this artwork indeed create a distinct and sensitive
            feel. The way they curve and flow contributes to the overall mood
            and narrative of the piece. How do you feel the lines interact with
            the different elements within the composition? Do they guide your
            eyes in a specific direction or highlight particular areas?
          </div>
          <div className="message query">
            I don't think the line interact with other compositions, but the
            color used in this artwork is very simple, pop-art style
          </div>
          {/* scroll to bottom */}
...
export default ChatWithFullTeaser;
