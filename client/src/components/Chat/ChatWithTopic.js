...
function ChatWithTopic({ artwork, initiateConversation }) {
  console.log("chat with topic switching");
  ...
  Start with a questioning to engage the audience.\n\
  Avoid overly detailed or complex questions that might reduce engagement, and keep questions concise and straightforward.\n\
  Ask about various aspects of the artwork that can be appreciated not only involving emotions (e.g., color, materials, composition, etc.).\n\
